...
sudo mv /tmp/autoscaler-commit-lint.groovy /usr/local/autoscaler-commit-lint.groovy
sudo mv /tmp/cve-operator-docker.groovy /usr/local/cve-operator-docker.groovy
sudo mv /tmp/helm-cve-operator-release.groovy /usr/local/helm-cve-operator-release.groovy
sudo mv /tmp/commit-lint-helm-operator.groovy /usr/local/commit-lint-helm-operator.groovy
